...
SLL_NODE *sll_create_node(int element, int priority) {
...
int sll_insert_front(SL_LIST *list, int element, int priority) {
  SLL_NODE *new_node = sll_create_node(element, priority);
...
int sll_insert_at(SL_LIST *list, int element, int index, int priority) {
...
int sll_insert_back(SL_LIST *list, int element, int priority) {
  SLL_NODE *new_node = sll_create_node(element, priority);
